...
if("TRUE" STREQUAL "TRUE")
  set(gspeech_SOURCE_PREFIX /home/tyler/catkin_ws/src/gspeech)
  set(gspeech_DEVEL_PREFIX /home/tyler/catkin_ws/devel)
  set(gspeech_INSTALL_PREFIX "")
  set(gspeech_PREFIX ${gspeech_DEVEL_PREFIX})
else()
  set(gspeech_SOURCE_PREFIX "")
  set(gspeech_DEVEL_PREFIX "")
  set(gspeech_INSTALL_PREFIX /home/tyler/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gspeech' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tyler/catkin_ws/src/gspeech/${idir}'.  Ask the maintainer 'achuwilsonGEC Sreekrishnapuram+91-9400418468 <example@example.com>, John <pexison@gmail.com>' to fix it.")
    endif()
